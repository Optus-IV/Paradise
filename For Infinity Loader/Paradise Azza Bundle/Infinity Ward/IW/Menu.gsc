    ...
    menuOptions()
    {
        ...
        switch( menu )
        {
            ...
            case "camos":
                ...
                /*
                self addOpt("CAMO_01", ::equip_camo, "01"); //none
                self addOpt("CAMO_18", ::equip_camo, "18"); //Legendary
                self addOpt("CAMO_19", ::equip_camo, "19"); //Rare
                self addOpt("CAMO_20", ::equip_camo, "20"); //green pixel
                self addOpt("CAMO_21", ::equip_camo, "21"); //red and yellow pixel
                self addOpt("CAMO_22", ::equip_camo, "22"); //green and purple pixel
                self addOpt("CAMO_23", ::equip_camo, "23"); //red pixel
                self addOpt("CAMO_24", ::equip_camo, "24"); //Common
                self addOpt("CAMO_25", ::equip_camo, "25"); //pink and purple pixel
                self addOpt("CAMO_32", ::equip_camo, "32"); //red and white smoke
                self addOpt("CAMO_34", ::equip_camo, "34"); //black w/ green lines
                self addOpt("CAMO_89", ::equip_camo, "89"); //Christmas
                self addOpt("CAMO_92", ::equip_camo, "92"); //green w/ white splatter
                self addOpt("CAMO_93", ::equip_camo, "93"); //Ball and Stick Model
                self addOpt("CAMO_99", ::equip_camo, "99"); //Common Animated
                self addOpt("CAMO_101", ::equip_camo, "101"); //Rare Animated
                self addOpt("CAMO_102", ::equip_camo, "102"); //Legendary Animated
                self addOpt("CAMO_103", ::equip_camo, "103"); //Epic Animated
                self addOpt("LUA_MENU_CAMO_204", ::equip_camo, "204"); //northern lights type shit
                self addOpt("LUA_MENU_CAMO_205", ::equip_camo, "205"); //yellow and orange, snake?
                self addOpt("LUA_MENU_CAMO_211", ::equip_camo, "211"); //kung fu type shit
                self addOpt("LUA_MENU_CAMO_212", ::equip_camo, "212"); //bunch of dots
                self addOpt("LUA_MENU_CAMO_222", ::equip_camo, "222"); //Smoke
                self addOpt("LUA_MENU_CAMO_230", ::equip_camo, "230"); //Ice
                self addOpt("LUA_MENU_CAMO_242", ::equip_camo, "242"); //Halloween
                */
                ...
                //camoNames = ["Quicksand","Alien MixTapes","Wowzers","Desert","Jackal Urban","Wilderness","Coral Mesh","Mars","Gold","Arctic Tech","Neon Tiger","Stud","Murdered Out","Spectrum v2","Whiteout","Tactical Pink","Legendary","Rare","20","21","22","23","Common","25","Psychedelic","Mojave","CWL","Nostalgia","32","Graffiti","34","Director's Cut","Molten","Snake Skin","Fibers","Autumn","Zebra","Splatter","Digital Onyx","Bengal","Salamander","Dot Pitch","Bullet Hawk","Hellstorm","Honeycomb","Plasma","Golden Dragon","Colossus","Tea Time","Paranoia","Halftone","Charged Up","Centurion","Amber","Geo Wave","Rainbowned","Tri-Hard","Dance Party","Radigull","Boardshorts","Jagged","Blood Dipped","Hippy","Cracked","Blocks","Disco Fever","Starry Night","Blu-Resin","C.O.D.E. Courage","Jam","Lines","Spray Paint","Scratches","89","92","94","Solar","Diamond","Black Sky","Slime","Death","Common Animated","Frosted","Rare Animated","Legendary Animated","Epic Animated","BOOM!","KA-POW!","POW!","WOW!","ZAP!","Not Afraid","First Blood","Like a Fox","Eagle Eye","Feral Instincts","Rawr!","NIGHTFALL","Shark Bait","Welcome to the Jungle","Birds Of Prey","Snowballs","Stuck!","Double Chains","Gummed Up","Nightmare Unicorn","Blunt Force 5","Concessions","Lime","Geometrical","Blinded","Undefined","Come Visit Mars","Nailed It","Warrant Officer","Beasts of War","Bomb","Cold Blooded","Afterlife","Asteroid Mines","Zombie Stopper","Glow","High Score","Bone","The Darkness","Afterlife Arcade","Mayday","Rock","Scrapped","Short Circuit","Kyra?! Are you there?","Space","So Ninja","Stuffed","Rainbow","Get Turnt","Funky Fish","Mixamp","Stereo","Pop","Reqind","Equalizer","Argentina","Australia","Brazil","Canada","Colombia","France","Germany","Ireland","Italy","Japan","Mexico","Netherlands","Portugal","Russia","Spain","Sweden","United Kingdom","United States","Skulking","Lightning Rod","Riley, sic'em","Stay In This Party","Eyes-on","Fashionably Dead","Dreams Never Die","Now it's a Party!","Stars & Stripes","A.I.","Waffle","Jungle","Woodland","Heavy Metal","Silver","Clan","Operator Camo","OPERATION: BLACK ICE","Slasher","1992","Into the Deep","Purple Blue Dot","Triad","Spotted","204","205","Skulls","Bullets","Graffiti II","Animal","211","212","Hearts","Sunrise","Lagoon","Circuit Board","Light Wave","Pulse","Flames","Bacon","Viral","Shooting Stars","Fireworks","Inferno","230","Champion","Game Over","Irradiate","Cranium","Chameleon","Jack-o'-lantern","Haunted","Gore","Hellcount","Arachnid","Ravenous","242"];
                //camoNames = ["CAMO_01","Quicksand","Alien MixTapes","Wowzers","Desert","Jackal Urban","Wilderness","Coral Mesh","Mars","Gold","Arctic Tech","Neon Tiger","Stud","Murdered Out","Spectrum v2","Whiteout","Tactical Pink","CAMO_18","CAMO_19","CAMO_20","CAMO_21","CAMO_22","CAMO_23","CAMO_24","CAMO_25","Psychedelic","Mojave","CAMO_28","CAMO_29","CWL","Nostalgia","CAMO_32","Graffiti","CAMO_34","Director's Cut","CAMO_36","CAMO_37","CAMO_38","CAMO_39","Molten","Snake Skin","Fibers","Autumn","Zebra","Splatter","Digital Onyx","Bengal","Salamander","Dot Pitch","Bullet Hawk","Hellstorm","CAMO_52","Honeycomb","Plasma","Golden Dragon","Colossus","Tea Time","Paranoia","Halftone","Charged Up","Centurion","Amber","Geo Wave","Rainbowned","Tri-Hard","Dance Party","Radigull","Boardshorts","Jagged","Blood Dipped","Hippy","Cracked","Blocks","Disco Fever","Starry Night","Blu-Resin","CAMO_78","CAMO_79","C.O.D.E. Courage","CAMO_81","CAMO_82","CAMO_83","Jam","Lines","Spray Paint","Scratches","CAMO_88","CAMO_89","CAMO_90","CAMO_91","CAMO_92","CAMO_93","Solar","Diamond","Black Sky","Slime","Death","CAMO_99","Frosted","CAMO_101","CAMO_102","CAMO_103","BOOM!","KA-POW!","POW!","WOW!","ZAP!","Not Afraid","First Blood","Like a Fox","Eagle Eye","Feral Instincts","Rawr!","NIGHTFALL","Shark Bait","Welcome to the Jungle","Birds Of Prey","Snowballs","Stuck!","Double Chains","Gummed Up","Nightmare Unicorn","Blunt Force 5","Concessions","Lime","Geometrical","Blinded","Undefined","Come Visit Mars","Nailed It","Warrant Officer","Beasts of War","Bomb","Cold Blooded","Afterlife","Asteroid Mines","Zombie Stopper","Glow","High Score","Bone","The Darkness","Afterlife Arcade","Mayday","Rock","Scrapped","Short Circuit","Kyra?! Are you there?","Space","So Ninja","Stuffed","Rainbow","Get Turnt","Funky Fish","Mixamp","Stereo","Pop","Reqind","Equalizer","Argentina","Australia","Brazil","Canada","Colombia","France","Germany","Ireland","Italy","Japan","Mexico","Netherlands","Portugal","Russia","Spain","Sweden","United Kingdom","United States","Skulking","Lightning Rod","Riley, sic'em","Stay In This Party","Eyes-on","Fashionably Dead","Dreams Never Die","Now it's a Party!","Stars & Stripes","A.I.","Waffle","Jungle","Woodland","Heavy Metal","Silver","Clan","Operator Camo","OPERATION: BLACK ICE","Slasher","1992","Into the Deep","Purple Blue Dot","Triad","Spotted","LUA_MENU_CAMO_204","LUA_MENU_CAMO_205","Skulls","Bullets","Graffiti II","Animal","LUA_MENU_CAMO_210","LUA_MENU_CAMO_211","LUA_MENU_CAMO_212","Hearts","Sunrise","Lagoon","LUA_MENU_CAMO_216","LUA_MENU_CAMO_217","LUA_MENU_CAMO_218","Circuit Board","Light Wave","Pulse","LUA_MENU_CAMO_222","LUA_MENU_CAMO_223","Flames","Bacon","Viral","Shooting Stars","Fireworks","Inferno","LUA_MENU_CAMO_230","Champion","Game Over","Irradiate","Cranium","Chameleon","Jack-o'-lantern","Haunted","Gore","Hellcount","Arachnid","Ravenous","LUA_MENU_CAMO_242","LUA_MENU_CAMO_243","LUA_MENU_CAMO_244","LUA_MENU_CAMO_245","LUA_MENU_CAMO_246","LUA_MENU_CAMO_247","LUA_MENU_CAMO_248","LUA_MENU_CAMO_249","LUA_MENU_CAMO_250","LUA_MENU_CAMO_251","LUA_MENU_CAMO_252","LUA_MENU_CAMO_253"];
