    ...
    menuOptions()
    {
        ...
        switch( menu )
        {
            ...
            case "atchmnts":
                ...
                attachNames = ["None","Iron Sights","ACOG Scope","ACOG Scope","ACOG Scope","ACOG Scope","Red Dot Sight","Red Dot Sight","Red Dot Sight","Red Dot Sight","Thermal","Thermal","Thermal","Holographic Sight","Holographic Sight","Holographic Sight","Holographic Sight","Hybrid Sight","Hybrid Sight","Tracker Sight","Tracker Sight","Variable Zoom","Variable Zoom","Variable Zoom","Variable Zoom","Variable Zoom","Silencer","Silencer","Silencer","Silencer","Silencer","Silencer","Chrome Lined","Muzzle Brake","Muzzle Brake","Flash Suppressor","Flash Suppressor","Flash Suppressor","Foregrip","Foregrip","Grenade Launcher","Grenade Launcher","Akimbo","Shotgun","Tactical Knife","Armor-Piercing","Rapid Fire","Extended Mags","Slug Rounds","Slug Rounds","Variable Zoom","Silencer"];

                for(i=0;i<attachIDs.size;i++)
                    self addOpt( attachNames[i], ::GivePlayerAttachment, attachIDs[i]);
            ...
            case "camos":
                ...
                for(a=0;a<45;a++)
                self addOpt(TableLookupIString("mp/camotable.csv", 0, a, 2), ::camoString, TableLookup("mp/camotable.csv", 0, a, 4));
                break;
